...
<head>
	...
	<script>
	       ...
	       $(document).ready(function(){
					...
					$("form#tdomf_form3 textarea").val("'Faculty Quote'");
					$("#customfields-tf-1-tf").val("Who said it?");
					$("form#tdomf_form3 textarea").click(function(){
						$("form#tdomf_form3 textarea").val("");
					});
					$("#customfields-tf-1-tf").click(function(){
						$("#customfields-tf-1-tf").val("");
					});
...
<body>
	...
	<div class="wrapperUserSubmit">
		<?php
		if( have_posts()) :?>
		<?php if ( !function_exists('dynamic_sidebar') || !dynamic_sidebar('facultyQuotes') ) : ?>
	         <?php endif; ?>
				...
				while( have_posts()) :
					...
					?>
						...
						<div class="caughtYouContainerSingle">
							<p class="caughtYouSingle">"<?php echo(get_the_content()); ?>" - <em><?php echo get_post_meta($post->ID, 'TDOMF Form #3 Custom Field #_1', true)?></em></p>
